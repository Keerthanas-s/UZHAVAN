...
function Profile() {
  ...
  const handleSave = async () => {
    try {
      await farmerApi.updateProfile(profile);
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={4}>
          <Paper elevation={0} sx={{ p: 4, border: "1px solid #e0e0e0", borderRadius: "16px", textAlign: "center" }}>
            ...
            >
              {profile.name ? profile.name.substring(0, 2).toUpperCase() : "RP"}
            </Avatar>
            ...
            <Box sx={{ display: "inline-flex", alignItems: "center", gap: 0.5, px: 2, py: 0.5, bgcolor: "#e8f5e9", color: "#2e7d32", borderRadius: "12px", fontSize: "0.85rem", fontWeight: "bold" }}>
              <CheckCircle fontSize="small" /> Verified Account
            </Box>
          </Paper>
        </Grid>
