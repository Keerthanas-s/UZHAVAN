    ...
    <Box sx={{ p: { xs: 2.5, md: 4 }, background: "linear-gradient(180deg, #f8fafc 0%, #ffffff 100%)", minHeight: "100vh", fontFamily: globalFont }}>
      <Box sx={{ mb: 4.5 }}>
        ...
        <Typography color="text.secondary" sx={{ fontFamily: globalFont, fontWeight: "600", fontSize: "0.95rem", mt: 0.5 }}>
          Compare crop valuations dynamically across district wholesale agricultural hubs (APMC).
        </Typography>
      </Box>
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ py: 1 }}>
                    ...
                    <Typography variant="caption" color="text.secondary" sx={{ fontFamily: globalFont, fontSize: "0.78rem", fontWeight: "600", display: "block", lineHeight: 1.4 }}>
                      Supply arrivals are expected to dip by 10% next week. Price projected to RISE by 8%-12%.
                    </Typography>
                  </Box>
                  <Box sx={{ py: 1, mt: 1 }}>
                    ...
                    <Typography variant="caption" color="text.secondary" sx={{ fontFamily: globalFont, fontSize: "0.78rem", fontWeight: "600", display: "block", lineHeight: 1.4 }}>
                      Fresh harvest inflows from Chennai & Coimbatore are stable. Prices will remain flat.
                    </Typography>
                  </Box>
                </CardContent>
              </Card>
